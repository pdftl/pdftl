...
def build_type1_font_dict(glyphs: dict[str, tuple[int, list]]) -> dict:
    """
    ...
    return {
        ...
        # passing the real list here writes the compact "/Encoding
        # StandardEncoding def" form instead of a full 256-entry array.
...
def build_type1_bytes(glyphs: dict[str, tuple[int, list]]) -> bytes:
    """
    ...
    font.encoding = "ascii"
    font.font = build_type1_font_dict(glyphs)
